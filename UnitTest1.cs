...
public class UnitTest1
{
    ...
    public void Test7()
    {
        Assert.Equal("Indirizzo mail non valido", ObfuscationServices.ObfuscateEmail("@carmelocarmeli.net"));
    }
    [Fact]
    public void Test8()
    {
        Assert.Equal("Indirizzo mail non valido", ObfuscationServices.ObfuscateEmail("info@carmelocarmeli.n"));
    }
    [Fact]
    public void Test9()
    {
        Assert.Equal("i***@c************i.it", ObfuscationServices.ObfuscateEmail("info@carmelocarmeli.it"));
    }
}